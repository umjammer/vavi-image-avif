...
public interface AvifLibrary extends Library {
	...
	public static interface avifChannelIndex {
		/** <i>native declaration : avif/avif.h:92</i> */
		public static final int AVIF_CHAN_R = 0;
		/** <i>native declaration : avif/avif.h:93</i> */
		public static final int AVIF_CHAN_G = 1;
		/** <i>native declaration : avif/avif.h:94</i> */
		public static final int AVIF_CHAN_B = 2;
	...
	public static final int AVIF_VERSION_MAJOR = (int)0;
	/** <i>native declaration : avif/avif.h</i> */
	public static final int AVIF_VERSION_MINOR = (int)10;
	/** <i>native declaration : avif/avif.h</i> */
	public static final int AVIF_VERSION_PATCH = (int)1;
	/** <i>native declaration : avif/avif.h</i> */
	public static final int AVIF_VERSION_DEVEL = (int)0;
	/** <i>native declaration : avif/avif.h</i> */
	public static final int AVIF_VERSION = (int)((0 * 1000000) + (10 * 10000) + (1 * 100) + 0);
	/** <i>native declaration : avif/avif.h</i> */
	 ...
	 */
	void avifImageCopy(avifImage dstImage, avifImage srcImage, int planes);
	/**
	 ...
	 */
	void avifImageAllocatePlanes(avifImage image, int planes);
	/**
